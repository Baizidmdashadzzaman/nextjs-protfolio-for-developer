				...
				<div className="container">
					...
					<div className="row justify-content-center">
						<div className="col-lg-7 col-md-8 col-sm-9 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
							...
							<br/>
							<Image width="635" height="477" src="/assets/images/gifs/e4f5ed296c252b0de33002019836385f.gif" alt="image_not_found" />
						</div>
					</div>
					...
					<div className="row">
						<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div className="service-default plr-30 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
								<span className="item-icon">
									<Image width="58" height="58" src="/assets/images/icons/icon_14.png" alt="image_not_found" />
								</span>
						...
						<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div className="service-default plr-30 aos-init aos-animate" data-aos="fade-up" data-aos-delay="500">
								<span className="item-icon">
									<Image width="58" height="58" src="/assets/images/icons/icon_15.png" alt="image_not_found"/>
								</span>
						...
						<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div className="service-default plr-30 aos-init aos-animate" data-aos="fade-up" data-aos-delay="700">
								<span className="item-icon">
									<Image width="58" height="58" src="/assets/images/icons/icon_16.png" alt="image_not_found"/>
								</span>
